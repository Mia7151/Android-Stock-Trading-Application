...
public class Fragment_page2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WebView myWebView = v.findViewById(R.id.webview2);
        myWebView.getSettings().setAllowFileAccess(true);
        myWebView.getSettings().setJavaScriptEnabled (true);
        myWebView.loadUrl("file:///android_asset/highcharts2.html");
        ...
        myWebView.setWebViewClient(new WebViewClient(){
            public void onPageFinished(WebView view, String url){
                ...
                myWebView.loadUrl("javascript:show2('" + stock + "')"); //if passing in an object. Mapping may need to take place
            }
        });
